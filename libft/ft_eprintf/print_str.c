...
/*   Updated: 2025/04/17 16:21:22 by jgrigorj         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "ft_eprintf.h"

static int	print_str_left(char *ch, int *wp, char *flags, int str_len)
{
	int	i;
...
static int	print_str_right(char *ch, int *wp, char *flags, int str_len)
{
	int	i;
